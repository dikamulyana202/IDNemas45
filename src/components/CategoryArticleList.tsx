// components/CategoryArticleList.tsx
"use client";
...
// Copy interfaces from ArticleList
interface Category {
   id: string;
   name: string;
   _count?: {
...
export default function CategoryArticleList({ categoryName }: CategoryArticleListProps) {
         ...
         {!loading && articles.length === 0 && (
            <div className="text-center py-12">
               ...
               <p className="text-gray-600">
                  Tidak ada artikel dalam kategori {categoryName}.
               </p>
            </div>
         )}
